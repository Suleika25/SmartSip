...
export const HotDrinks = (): JSX.Element => {
  const hotDrinks = [
    {
      name: "Irish Coffee",
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-[#121212]">
      <section className="w-[360px] h-[800px] relative bg-[#121212] overflow-y-scroll translate-y-[-1rem] animate-fade-in opacity-0 pt-8">
        ...
        <h2 className="absolute top-[63px] left-[101px] [font-family:'Roboto',Helvetica] font-medium text-white text-[26px] tracking-[-0.52px] leading-[normal] whitespace-nowrap">
          Heissgetränke
        </h2>
        <Button
          variant="ghost"
